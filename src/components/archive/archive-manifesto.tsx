...
export function ArchiveManifesto({
  ...
  return (
    <section
      id="foreword"
      className="scroll-mt-20 border-t border-[color-mix(in_srgb,var(--line)_70%,transparent)] py-[72px]"
    >
      <div className="mx-auto max-w-[1180px] px-6 sm:px-8">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="space-y-5 text-[19px] leading-[1.65] text-[var(--ink)]">
            ...
            <p>
              Só o histórico — pace, volume, frequência — organizado de um
              jeito que dá pra olhar e entender, sem rolar feed nem ler
              legenda de ninguém.
            </p>
            <p>
              Hoje qualquer pessoa pode conectar o Strava e ter o mesmo
              arquivo.
            </p>
          </div>
          ...
          <div className="surface-soft grain-surface self-start rounded-3xl p-6 font-mono text-[13px]">
            {[
              ...
              { k: "ACESSO", v: "Gratuito" },
              {
                k: "REGISTROS ATIVOS",
                v: data
                  ? `${data.stats.totalRuns.toLocaleString("pt-BR")}+`
                  : "—",
              },
